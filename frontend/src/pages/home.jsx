...
function Home() {
  ...
  return (
    <div>
      <Navbar />
      {/* Middle Section */}
      <section className="w-full flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-b from-[#10111D] to-green-300">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            We Make{" "}
            <span className="relative whitespace-nowrap text-green-300 dark:text-green-400">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
              ...
              <span className="relative ">Connecting with Coaches</span>
            </span>{" "}
            Easier with Jetson AI
          </h1>
          <p className="mx-auto mb-8 max-w-2xl text-lg">
            Professional photography services for weddings, events, portraits,
            and commercial shoots. Let us tell your story through our lens.
          </p>
          {/* CTA Button */}
          <div
          ...
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600">
                The latest items added to your catalog. If no products appear, please check that your backend is running and the API is available.
              </p>
            </div>
            <Link
              to="/fetch-products"
              className="inline-flex items-center rounded-full border border-green-600 bg-green-50 px-4 py-2 text-sm font-semibold text-green-700 transition hover:bg-green-100"
            >
              View all products
            </Link>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {recentproducts.length > 0 ? (
              recentproducts.map((product) => (
                <div key={product.id} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex items-center justify-between text-sm text-slate-900">
                      ...
                      <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600">Qty {product.Qty ?? "-"}</span>
                    </div>
                  </div>
                </div>
              ))
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="font-bold">SynthGen AI</h3>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700">
                Fast-tracking our listing was the best marketing decision we
                made. Went from zero to 500+ daily users in just two weeks!
                EliteAI.tools put us in front of the perfect audience.
              </p>
              <div className="flex items-center mt-4 text-gray-500">
                <svg
                  className="w-5 h-5 mr-1"
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700">
                As a bootstrapped startup, we needed cost-effective promotion.
                The Boosted plan delivered incredible ROI - our demo requests
                increased 3x in the first month alone. Highly recommend!
              </p>
              <div className="flex items-center mt-4 text-gray-500">
                <svg
                  className="w-5 h-5 mr-1"
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700">
                The SEO boost from being listed on EliteAI.tools is incredible.
                We've climbed to the first page for several key search terms.
                The quality of traffic converts at nearly 2x our other channels.
              </p>
              <div className="flex items-center mt-4 text-gray-500">
                <svg
                  className="w-5 h-5 mr-1"
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700">
                We tried several directories but EliteAI.tools stands out. The
                curation process means you're alongside other quality tools,
                which gives users confidence. Our conversions are up 35% from
                this traffic!
              </p>
              <div className="flex items-center mt-4 text-gray-500">
                <svg
            ...
            <div className="p-6 bg-white rounded-lg shadow-md transition-transform hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-gray-700">
                Investors actually mentioned seeing us on EliteAI.tools during
                our seed round! The directory has become a go-to resource for
                the industry. Still getting consistent traffic 6 months after
                listing.
              </p>
              <div className="flex items-center mt-4 text-gray-500">
                <svg
