                ...
                >
                  ...
                  <form onSubmit={handleSendEmail} className="mt-8 space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full rounded-2xl bg-[#FF7F50] hover:brightness-105 hover:shadow-md active:scale-[0.99] py-3.5 px-4 text-sm font-semibold text-white shadow-sm transition-all duration-150 disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer"
                    >
                      {loading ? (
                        <>
                          <svg
