...
import { buyProduct, cancelOrder, fetchOrders, fetchSingleOrder } from "./controllers/orderController.js"
...
app.get("/fetch-single-product/:id", fetchSingleProduct)
app.patch("/update-product/:id", verifyToken, editProduct)
app.delete("/delete-product/:id", verifyToken, deleteProduct)

// ---- cart ----
app.post("/product/add-to-cart", verifyToken, addToCart)
app.get("/cart", verifyToken, fetchCart)
app.delete("/cart/:id", verifyToken, removeFromCart)

// ---- order ----
app.post("/product/buy", verifyToken, buyProduct)
app.post("/product/cancel/:id", verifyToken, cancelOrder)
app.get("/orders", verifyToken, fetchOrders)
